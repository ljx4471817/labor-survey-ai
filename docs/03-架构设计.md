...
flowchart TD
    ...
    RET --> VEC["Chroma 570: 428 QA + 142 chunk"]
    RET --> BM25["BM25 570: 428 QA + 142 chunk"]
...
- Chroma 与 BM25 都覆盖 QA/chunk 双数据源，两个索引的现行总量均为 570。
...
| `whitelist.html` | 白名单管理页（CRUD + 标准调查点级联选择 + 翻页；CSV 导入已停用） |
...
│   ├── backend/data/bm25_index.json  BM25（双源 570 = 428 QA + 142 chunk）
